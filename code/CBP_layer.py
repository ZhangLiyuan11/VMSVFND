...
class CompactBilinearPooling(nn.Module):
    ...
    def forward(self, bottom1, bottom2):
        ...
        batch_size, catch_num,_  = bottom1.size()

        # contiguous() 拷贝一份tensor，和原来的tensor完全没有联系
        ...
        cbp = cbp_flat.view(batch_size, catch_num, self.output_dim)
...
#
#     bottom1 = Variable(torch.randn(16, 83, 128)).cuda()
#     bottom2 = Variable(torch.randn(16, 83, 128)).cuda()
#
#     layer = CompactBilinearPooling(128, 128, 128)
#     layer.cuda()
#     layer.train()
#
